...
const floatBtnClass =
  'flex h-11 w-11 items-center justify-center rounded-full text-white shadow-md ring-2 ring-white/90 transition-transform hover:scale-105 sm:h-12 sm:w-12';
...
export function WhatsAppFloatButton() {
  ...
  return createPortal(
    <div className="fixed bottom-[max(1.25rem,env(safe-area-inset-bottom))] right-4 z-[9999] flex flex-col gap-2.5 sm:right-6">
      <button
        type="button"
        onClick={openContact}
