    ...
    <div className="min-h-dvh bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-2 lg:gap-16 lg:py-24">
          ...
          <div className="order-1 min-w-0 rounded-2xl border-2 border-amber-200/80 bg-gradient-to-br from-sky-50 via-white to-amber-50 p-3 shadow-lg shadow-sky-500/10 sm:p-6 lg:order-2 dark:border-sky-800 dark:from-sky-950/40 dark:via-background dark:to-amber-950/30">
