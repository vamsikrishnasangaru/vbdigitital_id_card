...
export const STUDENT_FIELD_CATALOG: {
  ...
  { label: 'Student Child ID', fieldType: 'childId', placeholder: '{{child_id}}' },
  { label: 'Father Name', fieldType: 'fatherName', placeholder: '{{father_name}}' },
  { label: 'Mother Name', fieldType: 'motherName', placeholder: '{{mother_name}}' },
